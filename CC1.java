...
public class CC1
{
	public static void main ( String [] args )
	{
		...
		do
		{
			System . out . println ( " Desidera Versare o Prelevare denaro? Digiti \"1\" (uno), se desidera versare; digiti \"2\" (due), se desidera prelevare; 				digiti \"3\" (tre), se desidera visualizzare il Suo saldo; digiti \"0\" (zero), se desidera terminare le operazioni. \n Effettui la Sua scelta ora: \t 				" );
			s = in . nextInt();
			if
			( s == 1 )
			{
